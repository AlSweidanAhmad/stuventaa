...
const VisualGallery = () => {
  ...
  // ✅ Load translated items (names + locations) from i18n JSON
  const items = t('gallery.items', { returnObjects: true });

  // ✅ Keep image links EXACTLY as in your original code
  const landmarks = [
    {
      ...items[0],
  ...
  return (
    <section className="bg-white py-16 lg:py-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        {/* Added padding and margin-bottom for heading */}
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
              ...
              <div className="p-8">
                ...
                <p className="text-[#FF6600] font-medium text-lg">
                  {landmark.location}
                </p>
                {/* Adjusted font size */}
              </div>
